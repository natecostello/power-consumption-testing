...
"""Useful processing is producing a plot of power consumption and reporting the average power consumption"""
...
'rd6018.Voltage Output.V'
'rd6018.Current Output.A'
'rd6018.Power Output.W'
'rd6018.External Temperature.C'

"""Calculate minimum power"""
min_power = df[['rd6018.Power Output.W']].min()
print('Min Power = ' + min_power)

"""Calculate maximum power"""
max_power = df[['rd6018.Power Output.W']].max()
print('Max Power = ' + max_power)


"""Calculate average power"""
average_power = df[['rd6018.Power Output.W']].mean()
print('Average Power = ' + average_power)

"""Calculate average temperature"""
average_temp = df[['rd6018.External Temperature.C']].mean()
print('Average Temperature = ' + average_temp)

"""Plot all four Riden parameters on a shared X axis"""
# stack subplots 
# max temp vs several params for rising temp
fig, axs = plt.subplots(4, sharex=True)
plot_description = 'All Parameters'
plot_title = plot_description + ' ' + parsedTitle
plot_filename = plot_description.replace(' ', '-').lower() + '-' + parsedTitle + '.png'
#fig.suptitle(plot_title)
axs[0].plot(df[['rd6018.Power Output.W']], label="Power", color="red")
axs[1].plot(df[['rd6018.External Temperature.C']], label="Temperature", color="blue")
axs[2].plot(df[['rd6018.Voltage Output.V']], label="Voltage", color="green")
axs[3].plot(df[['rd6018.Current Output.A']], label="Current", color="orange")
...
"""Plot power alone"""
df[['rd6018.Power Output.W']].plot()
plot_description = 'Power' + 'Pave ' + average_power + ' W Tave ' +  average_temp + 'C '
plot_title = plot_description + ' ' + parsedTitle
plot_filename = plot_description.replace(' ', '-').lower() + '-' + parsedTitle + '.png'
plt.title(plot_title)
